...
class FavoritesControllerTest < ActionController::TestCase
  ...
  test "should create favorite" do
    assert_difference('Favorite.count') do
      post :create, favorite: { recipeID: @favorite.recipeID, userID: @favorite.userID }
    end
  ...
  test "should update favorite" do
    patch :update, id: @favorite, favorite: { recipeID: @favorite.recipeID, userID: @favorite.userID }
    assert_redirected_to favorite_path(assigns(:favorite))
  end
