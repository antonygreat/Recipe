...
class IngredientsControllerTest < ActionController::TestCase
  ...
  test "should create ingredient" do
    assert_difference('Ingredient.count') do
      post :create, ingredient: { groupID: @ingredient.groupID, name: @ingredient.name }
    end
  ...
  test "should update ingredient" do
    patch :update, id: @ingredient, ingredient: { groupID: @ingredient.groupID, name: @ingredient.name }
    assert_redirected_to ingredient_path(assigns(:ingredient))
  end
